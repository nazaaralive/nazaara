...
export const termsContent = {
  ...
  agreement:
    "By accessing the Site, submitting information through it, purchasing a ticket to any event we produce, or attending an event, you agree to be legally bound by these Terms. If you do not agree to these Terms, you may not use the Site or attend our events.",
